...
public class Template6Fragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView2 =  view.findViewById(R.id.image_person_template6);
...
//            ll_prexp1.setVisibility(View.VISIBLE);
        ...
        linearlayout_EducationalQualification_3 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_3_template6);
        tv_educationQualification_3 = (TextView) view.findViewById(R.id.tv_educationQualification_3_template6);
        tv_instituteName_3 = (TextView) view.findViewById(R.id.tv_instituteName_3_template6);
        tv_passingYear_3 = (TextView) view.findViewById(R.id.tv_passingYear_3_template6);
        tv_Result_3 = (TextView) view.findViewById(R.id.tv_Result_3_template6); // Remove
        tv_boardName_3 = (TextView) view.findViewById(R.id.tv_boardName_3_template6); // Remove

        linearlayout_EducationalQualification_4 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_4_template6);
        tv_educationQualification_4 = (TextView) view.findViewById(R.id.tv_educationQualification_4_template6);
        tv_instituteName_4 = (TextView) view.findViewById(R.id.tv_instituteName_4_template6);
        tv_passingYear_4 = (TextView) view.findViewById(R.id.tv_passingYear_4_template6);
        tv_Result_4 = (TextView) view.findViewById(R.id.tv_Result_4_template6);
        tv_boardName_4 = (TextView) view.findViewById(R.id.tv_boardName_4_template6);

        linearlayout_EducationalQualification_5 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_5_template6);
        tv_educationQualification_5 = (TextView) view.findViewById(R.id.tv_educationQualification_5_template6);
        tv_instituteName_5 = (TextView) view.findViewById(R.id.tv_instituteName_5_template6);
        tv_passingYear_5 = (TextView) view.findViewById(R.id.tv_passingYear_5_template6);
        tv_Result_5 = (TextView) view.findViewById(R.id.tv_Result_5_template6);
        tv_boardName_5 = (TextView) view.findViewById(R.id.tv_boardName_5_template6);
    ...
    public void onClick(View v) {
        ...
        if (v == getButton_CompletePayment2){
            ResumeTemplate.templateName = "template6";
            verifyTheProcess();
