...
public class Template5Fragment extends Fragment implements View.OnClickListener{
...
//    private RelativeLayout ll_prexp1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_template5, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button_Back2 = (Button) view.findViewById(R.id.back_template5);
        button_Back2.setOnClickListener(this);

        getButton_CompletePayment2 = (Button) view.findViewById(R.id.completePaymentTemplate5);
        ...
        career_objective2 = (TextView) view.findViewById(R.id.tv_profile_description5);
...
//        linearLayout_layout1 = (LinearLayout) view.findViewById(R.id.linearLayout_Reference2_1);
        tv_ref1_name = (TextView) view.findViewById(R.id.tv_ref1_name5);
        tv_ref1_designation = (TextView) view.findViewById(R.id.tv_ref1_designation5);
        tv_ref1_company = (TextView) view.findViewById(R.id.tv_ref1_company5);
        tv_ref1_email = (TextView) view.findViewById(R.id.tv_ref1_email5);
        tv_ref1_contactnumber = (TextView) view.findViewById(R.id.tv_ref1_contactnumber5);
/*
...
//            linearLayout_layout1.setVisibility(View.VISIBLE);
     ...
     /*   if (ResumeProfilePart5.reference.size() > 1) {
        ...
        linearLayout_ProfessionalExp_Head = (RelativeLayout) view.findViewById(R.id.rl_work_exp1_template5);

//        ll_prexp1 = (RelativeLayout) view.findViewById(R.id.rl_WorkExp_template4);
        tv_pr_exp1_position = (TextView) view.findViewById(R.id.tv_wrk_exp1_job_title5);
        tv_pr_exp1_company = (TextView) view.findViewById(R.id.tv_wrk_exp1_cname5);
        tv_pr_exp1_company_address = (TextView) view.findViewById(R.id.tv_wrk_exp1_location5);
        tv_pr_exp1_service_time = (TextView) view.findViewById(R.id.tv_wrk_exp1_duration5);
        tv_pr_exp1_service_detail = view.findViewById(R.id.tv_wrk_exp1_description5);

        ll_prexp2 = (RelativeLayout) view.findViewById(R.id.rl_work_exp2_template5);
        tv_pr_exp2_position = (TextView) view.findViewById(R.id.tv_wrk_exp2_job_title5);
        tv_pr_exp2_company = (TextView) view.findViewById(R.id.tv_wrk_exp2_cname5);
        tv_pr_exp2_company_address = (TextView) view.findViewById(R.id.tv_wrk_exp2_location5);
        tv_pr_exp2_service_time = (TextView) view.findViewById(R.id.tv_wrk_exp2_duration5);
        tv_pr_exp2_service_detail = view.findViewById(R.id.tv_wrk_exp2_description5);
        ...
        tv_pr_exp4_position = (TextView) view.findViewById(R.id.tv_wrk_exp4_job_title5);
        tv_pr_exp4_company = (TextView) view.findViewById(R.id.tv_wrk_exp4_cname5);
        tv_pr_exp4_company_address = (TextView) view.findViewById(R.id.tv_wrk_exp4_location5);
        tv_pr_exp4_service_time = (TextView) view.findViewById(R.id.tv_wrk_exp4_duration5);
        tv_pr_exp4_service_detail = view.findViewById(R.id.tv_wrk_exp4_description5);
...
//            ll_prexp1.setVisibility(View.VISIBLE);
        ...
        linearlayout_EducationalQualification_1 = (RelativeLayout) view.findViewById(R.id.rl_education);
        tv_educationQualification_1 = (TextView) view.findViewById(R.id.tv_educationQualification_1_template5);
        tv_instituteName_1 = (TextView) view.findViewById(R.id.tv_instituteName_1_template5);
        tv_passingYear_1 = (TextView) view.findViewById(R.id.tv_passingYear_1_template5);
        tv_Result_1 = (TextView) view.findViewById(R.id.tv_Result_1_template5); // Remove
        tv_boardName_1 = (TextView) view.findViewById(R.id.tv_boardName_1_template5); // Remove

        linearlayout_EducationalQualification_2 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_2_template5);
        ...
        tv_educationQualification_3 = (TextView) view.findViewById(R.id.tv_educationQualification_3_template5);
        tv_instituteName_3 = (TextView) view.findViewById(R.id.tv_instituteName_3_template5);
        tv_passingYear_3 = (TextView) view.findViewById(R.id.tv_passingYear_3_template5);
        tv_Result_3 = (TextView) view.findViewById(R.id.tv_Result_3_template5); // Remove
        tv_boardName_3 = (TextView) view.findViewById(R.id.tv_boardName_3_template5); // Remove

        linearlayout_EducationalQualification_4 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_4_template5);
        tv_educationQualification_4 = (TextView) view.findViewById(R.id.tv_educationQualification_4_template5);
        tv_instituteName_4 = (TextView) view.findViewById(R.id.tv_instituteName_4_template5);
        tv_passingYear_4 = (TextView) view.findViewById(R.id.tv_passingYear_4_template5);
        tv_Result_4 = (TextView) view.findViewById(R.id.tv_Result_4_template5);
        tv_boardName_4 = (TextView) view.findViewById(R.id.tv_boardName_4_template5);

        linearlayout_EducationalQualification_5 = (LinearLayout) view.findViewById(R.id.linearlayout_EducationalQualification_5_template5);
        tv_educationQualification_5 = (TextView) view.findViewById(R.id.tv_educationQualification_5_template5);
        tv_instituteName_5 = (TextView) view.findViewById(R.id.tv_instituteName_5_template5);
        tv_passingYear_5 = (TextView) view.findViewById(R.id.tv_passingYear_5_template5);
        tv_Result_5 = (TextView) view.findViewById(R.id.tv_Result_5_template5);
        tv_boardName_5 = (TextView) view.findViewById(R.id.tv_boardName_5_template5);
